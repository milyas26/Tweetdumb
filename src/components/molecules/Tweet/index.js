...
const Tweet = ({ name, username, img, text, avatar, isReply }) => {
  const history = useHistory();

  return (
    <div className="tweet-item" onClick={() => history.push("/detail")}>
      <div className="user-info">
        <div className="avatar">
          <Photo src={avatar} isCircle width={45} />
        </div>
        <div className="detail">
          ...
          <div className="reply" style={{ display: isReply ? "" : "none" }}>
            <span>Membalas</span> <span>@amrazing</span>
          </div>
          <div className="content">
            <img src={img} alt="" style={{ display: img ? "" : "none" }} />
            <p>{text}</p>
          </div>
          <div className="stats">
            <div className="icon">
